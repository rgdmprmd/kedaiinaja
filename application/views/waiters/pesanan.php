...
<div class="modal fade" id="newPesananModal" tabindex="-1" role="dialog" aria-labelledby="newPesananModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="" class="form-users" id="form-pesananbaru" method="POST">
...
<script>
    $(function() {
        ...
        function getPesanan(url, status, search) {
            if (!url) {
                url = base_url + 'waiters/getPesanan'
            }
        ...
        function getDetail(id) {
            $.ajax({
                url: base_url + 'waiters/ajaxGetPesananById',
                method: 'POST',
                dataType: 'JSON',
                data: {
                    idJson: id
                ...
                success: function(hasil) {
                    ...
                    if (header.pesanan_status == 1) {
                        $('#status_pesanan_detail').html(`<option value="1">Ready</option>
                                <option value="2">Served</option>`);
                        $('#status_pesanan_detail').attr('disabled', false);
                    } else if (header.pesanan_status == 3) {
                        $('#status_pesanan_detail').html(`<option value="3">Paid</option>
                                <option value="4">Finish</option>`);
                        $('#status_pesanan_detail').attr('disabled', false);
                    } else {
                        $('#status_pesanan_detail').html(`<option value="0">Pending</option>
                                <option value="1">Ready</option>
                                <option value="2">Served</option>
                                <option value="3">Paid</option>
                                <option value="4">Finish</option>`);
                        $('#status_pesanan_detail').attr('disabled', true);
                    }
        ...
        $('#meja_id').select2({
            ajax: {
                url: base_url + 'waiters/ajaxGetMeja',
                dataType: 'JSON',
                delay: 250,
        ...
        $('#makanan_id').select2({
            ajax: {
                url: base_url + 'waiters/ajaxGetMenu',
                dataType: 'JSON',
                delay: 250,
                data: function(params) {
                    return {
        ...
        $(document).on('click', '.pesanan-edit', function(e) {
            ...
            $('#form-pesananbaru').attr('action', base_url + 'waiters/updateMenuDetail');
        ...
        $(document).on('change', '#status_pesanan_detail', function(e) {
            ...
            $.ajax({
                url: base_url + 'waiters/ajaxUpdateStatusHeaderPesanan',
                method: 'POST',
                dataType: 'JSON',
                data: {
                    idJson: id,
